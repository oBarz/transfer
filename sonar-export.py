...
SONARQUBE_URL = 'http://localhost:9090/api/issues/search' #Sonar Instance URL
PROJECT_KEY = 'test-maven' #Your Project Key
TOKEN = 'sqp_a54dbb45ea5d6aeafe88d4abae3204b05c91a8b6' #Your Project Token
